...
export class ProjectService {
  ...
  async updateProject(id: string, projectData: ProjectUpdate): Promise<Project> {
    ...
    const updatedProject: Project = {
      ...
      image: projectData.image ?? existingProject.image,
      ...
      attachments: projectData.attachments ?? existingProject.attachments,
      notes: projectData.notes ?? existingProject.notes,
      architecture: projectData.architecture ?? existingProject.architecture,
